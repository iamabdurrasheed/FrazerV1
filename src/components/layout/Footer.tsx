    ...
    <footer className="bg-gradient-to-br from-gray-100 via-gray-50 to-white text-gray-800 border-t border-gray-200">
      <div className="w-full px-3 sm:px-4 md:px-6 lg:px-8 xl:px-12 2xl:px-16">
        ...
        <div className="py-8 sm:py-12 md:py-16 lg:py-20">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-6 sm:gap-8 md:gap-10 lg:gap-12 xl:gap-16">
            {/* Company Info */}
            ...
            <div className="lg:col-span-1">
              <h4 className="text-base sm:text-lg md:text-xl font-semibold text-gray-900 mb-4 sm:mb-6">Product Categories</h4>
              <ul className="space-y-2 sm:space-y-3">
                {[
                  ...
                  <li key={item.name}>
                    <Link href={item.link} className="text-sm sm:text-base text-gray-700 hover:text-blue-500 transition-colors duration-200 flex items-center group">
                      <span className="w-1 sm:w-1.5 h-1 sm:h-1.5 bg-blue-500 rounded-full mr-2 sm:mr-3 group-hover:scale-125 transition-transform duration-200"></span>
                      {item.name}
                    </Link>
                  </li>
                ))}
            ...
            {/* Quick Links */}
            <div className="lg:col-span-1">
              <h4 className="text-base sm:text-lg md:text-xl font-semibold text-gray-900 mb-4 sm:mb-6">Quick Links</h4>
              <ul className="space-y-2 sm:space-y-3">
                {[
            ...
            <div className="lg:col-span-1">
              <h4 className="text-base sm:text-lg md:text-xl font-semibold text-gray-900 mb-4 sm:mb-6">Business Hours</h4>
              <div className="space-y-2 sm:space-y-3 text-sm sm:text-base text-gray-700 mb-6 sm:mb-8">
              ...
              {/* Social Links */}
              <div>
                <h5 className="text-sm sm:text-base font-semibold text-gray-900 mb-3 sm:mb-4">Follow Us</h5>
                <div className="flex space-x-3 sm:space-x-4">
                  <a href="#" className="w-8 h-8 sm:w-10 sm:h-10 bg-blue-500 hover:bg-blue-600 rounded-full flex items-center justify-center transition-all duration-300 transform hover:scale-110">
        ...
        {/* Service Features */}
        <div className="border-t border-gray-300 py-6 sm:py-8 md:py-10 lg:py-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
            {[
              ...
              <div key={index} className="text-center group">
                <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 mx-auto mb-3 sm:mb-4 bg-gray-200 rounded-full flex items-center justify-center group-hover:bg-gray-300 transition-all duration-300 transform group-hover:scale-110">
                  {feature.icon}
                </div>
                <h5 className="text-sm sm:text-base md:text-lg font-semibold text-gray-900 mb-1 sm:mb-2">{feature.title}</h5>
        ...
        {/* Bottom Footer */}
        <div className="border-t border-gray-300 py-4 sm:py-6 md:py-8">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-3 sm:space-y-0">
            ...
            <div className="flex flex-wrap justify-center sm:justify-end space-x-4 sm:space-x-6 text-xs sm:text-sm md:text-base">
